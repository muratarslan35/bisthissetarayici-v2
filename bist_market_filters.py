    ...
    try:
        ...
        for event in events:
            try:
                ...
                # Trading restriction decisions are deterministic.
                # Gemini may be used elsewhere for explanation/enrichment, but
                # cannot create a brüt-takas flag on its own.
...
def get_brut_list():
    ...
    # Critical restriction state must come from verified official KAP
    # disclosures (or explicit manual admin override), never a third-party
    # news page or AI-only extraction.
